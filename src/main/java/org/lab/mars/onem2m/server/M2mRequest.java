...
public class M2mRequest {
    private static final Logger LOG = LoggerFactory.getLogger(M2mRequest.class);

    public final static M2mRequest requestOfDeath = new M2mRequest(null, 0, 0,null);
     ...
     * @param bb
     */
    public M2mRequest(ChannelHandlerContext ctx, int xid, int type,ByteBuffer  bb ) {
      this.ctx=ctx;
        this.cxid = xid;
        this.type = type;
       this.request=bb;
