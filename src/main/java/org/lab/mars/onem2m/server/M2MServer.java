...
//
//	/*
//	 * 开始启动包括 1.创建sessionTracker 2.建立请求链 3.注册jmx
//	 */
//	public void startup() {
//		if (sessionTracker == null) {
...
//
//		StatPersisted	stat;		/*
//									 * Make sure to create a new object when
//									 * changing
//									 */
//
//		int				childCount;
...
//		RequestHeader h = new RequestHeader();// 反序列化请求头，可以根据type来判断操作类型
