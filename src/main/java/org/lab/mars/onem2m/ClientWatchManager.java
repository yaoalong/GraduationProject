...
public interface ClientWatchManager {
     ...
     * internal structure as if the watches had triggered. The intent being that
     * the callee is now responsible for notifying the watchers of the event,
     * possibly at some later time.
     * 
     * @param state
     *            event state
     * @param type
