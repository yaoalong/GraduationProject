...
public class ConnectResponse implements Record {
    ...
    public ConnectResponse(int protocolVersion, int timeOut, long sessionId,
            byte[] passwd) {
    ...
    public int compareTo(Object peer_) throws ClassCastException {
        ...
        if (ret != 0)
            return ret;
        ret = (timeOut == peer.timeOut) ? 0 : ((timeOut < peer.timeOut) ? -1
                : 1);
        if (ret != 0)
            return ret;
        ret = (sessionId == peer.sessionId) ? 0
                : ((sessionId < peer.sessionId) ? -1 : 1);
        if (ret != 0)
            return ret;
        return ret;
    }
