...
import org.lab.mars.onem2m.ClientCnxn.EventThread.SendThread;
...
import org.lab.mars.onem2m.ZooKeeper.States;
import org.lab.mars.onem2m.ZooKeeper.WatchRegistration;
...
import org.lab.mars.onem2m.proto.AuthPacket;
import org.lab.mars.onem2m.proto.ConnectRequest;
...
import org.lab.mars.onem2m.proto.SetWatches;
...
public class ClientCnxn {
    ...
    class EventThread extends Thread {
        ...
        private void conLossPacket(Packet p) {
            ...
            case AUTH_FAILED:
                p.replyHeader
                        .setErr(KeeperException.Code.AUTHFAILED.intValue());
                break;
            case CLOSED:
        ...
        /**
         * This class services the outgoing request queue and generates the
         * heart beats. It also spawns the ReadThread.
         */
        class SendThread extends Thread {
            ...
            void readResponse(ByteBuffer incomingBuffer) throws IOException {
                ...
                if (replyHdr.getXid() == -1) {
                    ...
                    if (chrootPath != null) {
                        ...
                        if (serverPath.compareTo(chrootPath) == 0)
                            ...
                            event.setPath(serverPath.substring(chrootPath
                                    .length()));
                        else {
                ...
                // If SASL authentication is currently in progress, construct
                // and
                ...
                /*
                 * Since requests are processed in order, we better get a
            ...
            public void run() {
                ...
                while (state.isAlive()) {
                    try {
                        ...
                        if (state.isConnected()) {
                            // 1000(1 second) is to prevent race condition
                            // missing
                            ...
                            int timeToNextPing = readTimeout
                                    ...
                                    - ((clientCnxnSocket.getIdleSend() > 1000) ? 1000
                                            : 0);
                            // send a ping request either time is due or no
                            // packet
                        ...
                        // If we are in read-only mode, seek for read/write
                        // server
            ...
            /**
             * Callback invoked by the ClientCnxnSocket once a connection has
             * been established.
             * 
            ...
            public boolean clientTunneledAuthenticationInProgress() {
                ...
                // therefore authentication is (at the earliest stage of being)
                // in
                // progress.
                if (zooKeeperSaslClient == null) {
                    return true;
         ...
         * directly - rather it should be called as part of close operation.
         * This method is primarily here to allow the tests to verify
        ...
        /*
         * getXid() is called externally by ClientCnxnNIO::doIO() when packets
         * are sent from the outgoingQueue to the server. Thus, getXid() must be
         * public.
         */
        ...
        public void sendPacket(Record request, Record response,
                AsyncCallback cb, int opCode) throws IOException {
