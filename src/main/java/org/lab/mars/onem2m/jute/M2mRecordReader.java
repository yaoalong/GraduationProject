...
public class M2mRecordReader {
    ...
    static {
        ...
        try {
            archiveFactory.put("binary",
            		M2mBinaryInputArchive.class.getDeclaredMethod(
                        "getArchive", params));
            archiveFactory.put("csv",
            		M2mCsvInputArchive.class.getDeclaredMethod(
                        "getArchive", params));
            archiveFactory.put("xml",
                    M2mXmlInputArchive.class.getDeclaredMethod(
                        "getArchive", params));
     ...
     */
    public M2mRecordReader(InputStream in, String format)
    throws IOException {
