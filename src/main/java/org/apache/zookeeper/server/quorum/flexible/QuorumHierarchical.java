...
public class QuorumHierarchical implements QuorumVerifier {
    private static final Logger LOG = LoggerFactory
            .getLogger(QuorumHierarchical.class);
    ...
    /**
     * This constructor takes a set of properties. We use it in the unit test
     * for this feature.
     */
    ...
    /**
     * This contructor takes the two hash maps needed to enable validating
     * quorums. We use it with QuorumPeerConfig. That is, we declare weights and
     * groups in the server configuration file along with the other parameters.
     * 
     * @param numGroups
     * @param serverWeight
     * @param serverGroup
     */
    public QuorumHierarchical(int numGroups, HashMap<Long, Long> serverWeight,
            HashMap<Long, Long> serverGroup) {
    ...
    /**
     * Reads a configration file. Called from the constructor that takes a file
     * as an input.
     */
    ...
    public boolean containsQuorum(HashSet<Long> set) {
        ...
        LOG.debug("Majority group counter: " + majGroupCounter + ", "
                + numGroups);
